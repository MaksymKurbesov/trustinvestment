...
export const TransactionContext = createContext({
  transactionIsSent: false,
  setTransactionIsSent: () => {},
});

function App() {
  const [transactionIsSent, setTransactionIsSent] = useState(false);
  // const value = useMemo(() => ({ transactionIsSent, setTransactionIsSent }), [transactionIsSent]);

  return (
    <TransactionContext.Provider value={{ transactionIsSent, setTransactionIsSent }}>
      <AuthProvider>
        <div className="App">
          <Routes>
